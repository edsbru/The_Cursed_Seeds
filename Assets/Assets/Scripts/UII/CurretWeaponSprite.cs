...
public class CurretWeaponSprite : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (GameManager.instance.currentWeaponID == 3)
        {
            weaponImage.sprite = weaponsSprites[3];
        }
        if (GameManager.instance.currentWeaponID == 4)
        {
            weaponImage.sprite = weaponsSprites[4];
        }
        if (GameManager.instance.currentWeaponID == 5)
        {
            weaponImage.sprite = weaponsSprites[5];
        }
    }
}
