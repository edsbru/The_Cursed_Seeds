...
public class ShotingTypesFunctions : MonoBehaviour
{
    ...
    IEnumerator SniperShell(GameObject shells, GameObject gun)
    {
        yield return new WaitForSeconds(1f);
        Quaternion shellRot = shells.transform.rotation;
        Instantiate(shells, gun.transform.position, shellRot);
    }
    public void sniper(GameObject bullet, AudioClip sound, Animator animator, GameObject shells, CameraShake shake, GameObject gun, Transform canon, float timeShake, float magnitudeShake, float bulletDisspersion, PlayerMovement pM)
    {
        //feadBack
        shake.CameraShakeSettings(timeShake, magnitudeShake);
        ...
        StartCoroutine(SniperShell(shells, gun));
        ...
        pM.rbPlayer.AddForce(pM.KnockBackDir * 400, ForceMode2D.Impulse);
    ...
    public void TriShoot(GameObject bullet, AudioClip sound, Animator animator, GameObject shells, CameraShake shake, GameObject gun, Transform canon, float timeShake, float magnitudeShake, PlayerMovement pM)
    {
        //feedback
        shake.CameraShakeSettings(timeShake, magnitudeShake);

        pM.rbPlayer.AddForce(pM.KnockBackDir * 150, ForceMode2D.Impulse);
        ...
        //Gun Logic
        BulletNormal dispersionBullet = bullet.GetComponent<BulletNormal>();
        dispersionBullet.dispersionAngle = 0;
        GameObject temp = Instantiate(bullet, canon.position, Quaternion.identity);


        BulletNormal dispersionBullet1 = bullet.GetComponent<BulletNormal>();
        dispersionBullet.dispersionAngle = 50;
        GameObject temp1 = Instantiate(bullet, canon.position, Quaternion.identity);


        BulletNormal dispersionBullet2 = bullet.GetComponent<BulletNormal>();
        dispersionBullet.dispersionAngle = -50;
        GameObject temp2 = Instantiate(bullet, canon.position, Quaternion.identity);
    }
